      ...
      <div className="relative w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-6 text-center">
          ...
          <div>
            ...
            <p className="mt-1.5 text-sm text-black/50">Log in to keep building your Shopify app.</p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-black/50">
          No account yet?{" "}
          <Link href="/signup" className="font-medium text-black underline decoration-black/20 underline-offset-4 hover:decoration-black/50">
            Sign up
          </Link>
        </p>
      </div>
